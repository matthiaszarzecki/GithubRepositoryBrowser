...
An iOS-App that can search for and display github-repositories, made with UIKit. Created for an excercise within a few hours.

![Screenshot](repository_browser.png)
